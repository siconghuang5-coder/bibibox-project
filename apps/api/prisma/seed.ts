...
async function main() {
  ...
  const mobo = await upsertAccount({
    ...
    avatarUrl: '/static/accompanystaff1.png',
    tagline: '温柔学霸女友',
    digitalHuman: {
      slug: 'mobai',
      cozeBotId: '7577243839883870258',
  ...
  const mike = await upsertAccount({
    ...
    accountType: AccountType.DIGITAL_HUMAN,
    password: 'Human@123456',
    avatarUrl: '/static/accompanystaff1 (3).png',
    tagline: '阳光健身教练',
    digitalHuman: {
      slug: 'mike',
      cozeBotId: '7577233691508736046',
  ...
  const vivian = await upsertAccount({
    ...
    accountType: AccountType.DIGITAL_HUMAN,
    password: 'Human@123456',
    avatarUrl: '/static/accompanystaff1 (4).png',
    tagline: '心理疗愈师',
    digitalHuman: {
      slug: 'vivian',
  ...
  const caicai = await upsertAccount({
    ...
    accountType: AccountType.DIGITAL_HUMAN,
    password: 'Human@123456',
    avatarUrl: '/static/xiaomei.jpg',
    tagline: '穿搭时尚博主',
    digitalHuman: {
      slug: 'caicai-fashion',
      cozeBotId: '7577346892775129124',
  ...
  const liuruyan = await upsertAccount({
    ...
    accountType: AccountType.DIGITAL_HUMAN,
    password: 'Human@123456',
    avatarUrl: '/static/chenyixin.jpg',
    tagline: '夜谈陪伴系数字人',
    digitalHuman: {
      slug: 'liu-ruyan',
      cozeBotId: '7577346055978844194',
  ...
  const products = [
    ...
    },
    {
      ...
      priceCoins: 6800,
      stock: 1,
      coverUrl: '/static/accompanystaff1 (4).png',
      badge: '数字人',
      sortOrder: 2,
    ...
    },
    {
      ...
      priceCoins: 199,
      stock: 999,
      coverUrl: '/static/moments-sunset.png',
      badge: '礼物',
      sortOrder: 11,
      relatedAccountId: null,
    },
    {
      ...
      priceCoins: 1899,
      stock: 50,
      coverUrl: '/static/accompanystaff1 (2).png',
      badge: '精选',
      sortOrder: 20,
      relatedAccountId: null,
    },
  ...
  await seedOrder({
    ...
    product: {
      id: productMap.get('ai-core-mini')!.id,
      name: productMap.get('ai-core-mini')!.name,
      subtitle: productMap.get('ai-core-mini')!.subtitle,
      coverUrl: productMap.get('ai-core-mini')!.coverUrl,
      productType: productMap.get('ai-core-mini')!.productType,
      priceCoins: productMap.get('ai-core-mini')!.priceCoins,
      relatedAccountId: productMap.get('ai-core-mini')!.relatedAccountId,
    },
    quantity: 1,
  });
